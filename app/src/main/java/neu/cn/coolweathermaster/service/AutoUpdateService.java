package neu.cn.coolweathermaster.service;
...
public class AutoUpdateService extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        int setHour = 8 * 60 * 60 * 100; // 设定每8个小时自动更新天气数据
        long triggerAtTime = SystemClock.elapsedRealtime() + setHour;
